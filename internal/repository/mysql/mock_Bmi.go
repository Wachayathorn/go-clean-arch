...
func (_m *MockBmi) Create(ctx context.Context, bmi domain.BmiRepository) (domain.BmiRepository, error) {
	ret := _m.Called(ctx, bmi)

	var r0 domain.BmiRepository
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, domain.BmiRepository) (domain.BmiRepository, error)); ok {
		return rf(ctx, bmi)
	}
	if rf, ok := ret.Get(0).(func(context.Context, domain.BmiRepository) domain.BmiRepository); ok {
		r0 = rf(ctx, bmi)
	} else {
		r0 = ret.Get(0).(domain.BmiRepository)
	}

	if rf, ok := ret.Get(1).(func(context.Context, domain.BmiRepository) error); ok {
		r1 = rf(ctx, bmi)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *MockBmi_Create_Call) Run(run func(ctx context.Context, bmi domain.BmiRepository)) *MockBmi_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(domain.BmiRepository))
	})
	return _c
}

func (_c *MockBmi_Create_Call) Return(_a0 domain.BmiRepository, _a1 error) *MockBmi_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBmi_Create_Call) RunAndReturn(run func(context.Context, domain.BmiRepository) (domain.BmiRepository, error)) *MockBmi_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockBmi) Get(ctx context.Context) ([]domain.BmiRepository, error) {
	ret := _m.Called(ctx)

	var r0 []domain.BmiRepository
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) ([]domain.BmiRepository, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) []domain.BmiRepository); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]domain.BmiRepository)
...
func (_c *MockBmi_Get_Call) Return(_a0 []domain.BmiRepository, _a1 error) *MockBmi_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBmi_Get_Call) RunAndReturn(run func(context.Context) ([]domain.BmiRepository, error)) *MockBmi_Get_Call {
	_c.Call.Return(run)
	return _c
}

// GetByID provides a mock function with given fields: ctx, id
func (_m *MockBmi) GetByID(ctx context.Context, id int) (domain.BmiRepository, error) {
	ret := _m.Called(ctx, id)

	var r0 domain.BmiRepository
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (domain.BmiRepository, error)); ok {
		return rf(ctx, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, int) domain.BmiRepository); ok {
		r0 = rf(ctx, id)
	} else {
		r0 = ret.Get(0).(domain.BmiRepository)
	}
...
func (_c *MockBmi_GetByID_Call) Return(_a0 domain.BmiRepository, _a1 error) *MockBmi_GetByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBmi_GetByID_Call) RunAndReturn(run func(context.Context, int) (domain.BmiRepository, error)) *MockBmi_GetByID_Call {
	_c.Call.Return(run)
	return _c
}

// UpdateByID provides a mock function with given fields: ctx, bmi
func (_m *MockBmi) UpdateByID(ctx context.Context, bmi domain.BmiRepository) (domain.BmiRepository, error) {
	ret := _m.Called(ctx, bmi)
...
//   - ctx context.Context
//   - bmi domain.BmiRepository
func (_e *MockBmi_Expecter) UpdateByID(ctx interface{}, bmi interface{}) *MockBmi_UpdateByID_Call {
	return &MockBmi_UpdateByID_Call{Call: _e.mock.On("UpdateByID", ctx, bmi)}
}

func (_c *MockBmi_UpdateByID_Call) Run(run func(ctx context.Context, bmi domain.BmiRepository)) *MockBmi_UpdateByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(domain.BmiRepository))
	})
	return _c
...
func (_c *MockBmi_UpdateByID_Call) Return(_a0 domain.BmiRepository, _a1 error) *MockBmi_UpdateByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBmi_UpdateByID_Call) RunAndReturn(run func(context.Context, domain.BmiRepository) (domain.BmiRepository, error)) *MockBmi_UpdateByID_Call {
	_c.Call.Return(run)
	return _c
}
